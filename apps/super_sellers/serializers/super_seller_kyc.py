...
from apps.super_sellers.models.kyc_submission import SuperSellerKYCSubmission, IdentityDocType
from apps.events.models.super_seller_profile import SuperSellerProfile, KYCStatus

class SuperSellerKYCSubmitSerializer(serializers.ModelSerializer):
    class Meta:
        model = SuperSellerKYCSubmission
        fields = (
            "identity_type",
            "passport_image", 
            "id_front", 
...
class AdminSuperSellerKYCReviewSerializer(serializers.Serializer):
